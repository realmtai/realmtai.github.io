...
![][steps]{:style="display:block; margin-left:auto; margin-right:auto"}
...
| Engine mount: search for `intex Motor Mount Kit` | ![mount][mount] | ~$50 to ~$100 |
